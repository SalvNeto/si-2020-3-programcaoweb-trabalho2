...
if ($db->connect()) {
  ...
  $clis[] = new Cliente("teste1","teste1@gmail.com","Rua Fernando Correia da costa. Nº 25. Sumaré", "Rondonópolis","MT","M");
  $clis[] = new Cliente("teste2","teste2@gmail.com","Rua Alfredo de casto. Nº 25. Sumaré", "São Paulo","SP","F");
  foreach($clis as $cli) $daoCli->inserir($cli);
